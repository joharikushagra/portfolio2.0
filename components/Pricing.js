...
const Pricing = () => {
  return (
    ...
    >
      <div className="max-w-screen-xl  px-6 sm:px-8 lg:px-16 mx-auto flex flex-col w-full text-center justify-center" id="testimoni">
      ...
      {/* <div className="max-w-screen-xl  px-6 sm:px-8 lg:px-16 mx-auto flex flex-col w-full text-center justify-center" id="achievements"> */}
        <h3 className="text-2xl sm:text-3xl lg:text-4xl font-medium text-black-600 leading-normal w-9/12 sm: lg:w-4/12 mx-auto">
          Achievements
        </h3>
      ...
      {/* <div className="flex flex-col w-full my-16" id="workexperience"> */}
      <div className="max-w-screen-xl  px-6 sm:px-8 lg:px-16 mx-auto flex flex-col w-full text-center justify-center" id="workexperience">
        <h3 className="text-2xl sm:text-3xl lg:text-4xl font-medium text-black-600 leading-normal w-9/12 sm: lg:w-4/12 mx-auto">
          Work Experience
        </h3>
        <div className="w-full flex flex-col justify-start py-12">
